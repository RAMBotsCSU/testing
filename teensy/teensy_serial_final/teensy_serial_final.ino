...
String fl_RFB_string, fl_RLR_string, br_RFB_string, br_RLR_string, bl_RFB_string, bl_RLR_string  = "";
...
void loop() {
    ...
    printString =  "front_right: " + fr_RFB_string + ", " + fr_RLR_string + ", " + legLength1_string + " front_left: " +  fl_RFB_string + ", " + fl_RLR_string + ", " + legLength2_string;
    ...
    if (currentMillis - previousMillis >= 10) {  // start timed event
      ...
      fl_RFB_string = String(fl_RFB);
      fl_RLR_string = String(fl_RLR);
      legLength2_string = String(legLength2);
